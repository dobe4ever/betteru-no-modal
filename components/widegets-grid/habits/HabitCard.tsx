        ...
        <div className="flex items-center w-full gap-3">
          ...
          <div className="flex-grow flex flex-col justify-center min-w-0">
            ...
            <div className="flex items-center space-x-1 mt-0.5">
              {habit.pinned && <Pin className="h-3.5 w-3.5 text-orange-500" aria-hidden="true" />}
              {habit.hasAlarm && <AlarmClock className="h-3.5 w-3.5 text-orange-500" aria-hidden="true" />}
              {habit.repeating && <Repeat className="h-3.5 w-3.5 text-orange-500" aria-hidden="true" />}
